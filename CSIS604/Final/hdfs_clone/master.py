...
def set_conf():
  ...
  print("block_size: "+str(MasterService.exposed_Master.block_size))
  print("duplication number: "+str(MasterService.exposed_Master.replication_factor))
  print("number of nodes: "+str(len(minions)))
  print("\n-------------------------------")
